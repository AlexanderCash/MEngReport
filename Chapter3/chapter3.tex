...
\begin{equation}
	timeDelta = \frac{1}{uavSpeed \div stepSize}
\end{equation}
...
\caption[Task 2: Plotting the Effects of Wind on Dubins Paths in MATLAB]{The plot results of sub-task 2 in MATLAB, showing the groud relative path corresponding to an air relative Dubins path}
\label{fig:pp2demo}
\end{figure}
